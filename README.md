...
[![YouTube](https://img.shields.io/badge/YouTube-Subscribe-FF0000?style=classic&logo=youtube&logoColor=white)](https://www.youtube.com/@rameezimdad)
...
Want a DESIGN.md built for a specific website? [Request one on WhatsApp](https://wa.me/923224083545) — including private requests delivered exclusively to you.

## Made by Rameez Scripts
...
<h4>Developed by Mohammad Rameez Imdad (Rameez Scripts)</h4>

<sub>Need a custom dashboard, web app, or design system? Let's build it.</sub>

<br/><br/>

<a href="https://wa.me/923224083545"><img src="https://img.shields.io/badge/WhatsApp-For%20Custom%20Projects-25D366?style=for-the-badge&logo=whatsapp&logoColor=white" alt="WhatsApp" /></a>
<a href="https://www.youtube.com/@rameezimdad"><img src="https://img.shields.io/badge/YouTube-Subscribe%20for%20more!-FF0000?style=for-the-badge&logo=youtube&logoColor=white" alt="YouTube" /></a>
...
- [**Runway**](design-md/runwayml/DESIGN.md) - AI creative-tools platform with an editorial film-festival aesthetic — cinematic dark heroes, paper-white reading bands, single proprietary sans, and pure black pill CTAs.
...
- [**Sanity**](design-md/sanity/DESIGN.md) - Headless content platform with a dark-first editorial marketing surface — 112px display type, IBM Plex Mono technical eyebrows, and a single coral-red accent reserved for the highest-priority CTA.
...
- [**Mastercard**](design-md/mastercard/DESIGN.md) - Global payments network. Warm cream canvas, orbital pill shapes, editorial warmth
...
- [**Shopify**](design-md/shopify/DESIGN.md) - E-commerce platform. Dark-first cinematic, neon green accent, ultra-light display type
- [**Starbucks**](design-md/starbucks/DESIGN.md) - Coffee retail flagship. Four-tier earth-green system, warm cream canvas, proprietary SoDoSans typography

### Media & Consumer Tech

- [**Apple**](design-md/apple/DESIGN.md) - Consumer electronics. Premium white space, SF Pro, cinematic imagery
- [**HP**](design-md/hp/DESIGN.md) - PC and printer maker. Pure white canvas, HP Electric Blue signal CTA, geometric Forma DJR Micro, blue chevron decorations
...
- [**PlayStation**](design-md/playstation/DESIGN.md) - Gaming console retail. Three-surface channel layout, cyan hover-scale interaction
...
- [**BMW M**](design-md/bmw-m/DESIGN.md) - Performance automotive. Motorsport-inspired contrast, M color accents, precision-driven layout
...
- [**Dell (1996)**](design-md/dell-1996/DESIGN.md) - Catalog-era enterprise web. Literal black page frame, flat color-block "ribbon cards", chunky Helvetica-Black titles over Times Roman body, and hand-cut GIF stickers (NEW! bursts, award seals, beveled product photos).
- [**Nintendo.com (2001)**](design-md/nintendo-2001/DESIGN.md) - Y2K "console chrome" web. Brushed-periwinkle beveled metal panels, a halftone-dotted carbon nav glowing amber, outlined Arial-Black box-art wordmarks over circuit-board hero fields, and a pixel Mario welcome bubble.
...
Have a suggestion or want a custom DESIGN.md built? Reach out on [WhatsApp](https://wa.me/923224083545).
